 ...
 */
public class OriginalGtidSetButWithoutString {
     ...
     */
    public OriginalGtidSetButWithoutString(String gtidSet) {
     ...
     */
    public UUIDSet getUUIDSet(UUID uuid) {
        return map.get(uuid);
    }
    ...
    public boolean add(Gtid gtid) {
        UUID sourceId = gtid.getServerId();
        long transactionId = gtid.getTransactionId();
     ...
     * Note that if two {@link OriginalGtidSetButWithoutString}s are equal, then they both are subsets of the other.
     ...
     */
    public boolean isContainedWithin(OriginalGtidSetButWithoutString other) {
        if (other == null) {
            return false;
        }
        if (this == other) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OriginalGtidSetButWithoutString) {
            OriginalGtidSetButWithoutString that = (OriginalGtidSetButWithoutString) obj;
     ...
     * @see OriginalGtidSetButWithoutString
     */
