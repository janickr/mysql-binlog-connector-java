...
import com.github.shyiko.mysql.binlog.gtidprofilingpoc.newgtid.gtid.MySqlGtidSet;
 ...
 */
public class BinaryLogClientForNewGtidSet implements BinaryLogClientMXBean {
    ...
    protected MySqlGtidSet gtidSet;
     ...
     * @see BinaryLogClientForNewGtidSet#BinaryLogClient(String, int, String, String, String)
	 * @param username login name
	 * @param password password
     */
    public BinaryLogClientForNewGtidSet(String username, String password) {
	 ...
	 * @param password password
     */
    public BinaryLogClientForNewGtidSet(String schema, String username, String password) {
	 ...
	 * @param password password
     */
    public BinaryLogClientForNewGtidSet(String hostname, int port, String username, String password) {
     ...
     * @param password password
     */
    public BinaryLogClientForNewGtidSet(String hostname, int port, String schema, String username, String password) {
        ...
        synchronized (gtidSetAccessLock) {
            if ( !gtidStr.equals("") ) {
                if ( MariadbGtidSet.isMariaGtidSet(gtidStr) ) {
                    ...
                    this.gtidSet = MySqlGtidSet.fromString(gtidStr);
                }
            }
        }
    }
    ...
    *
    ...
    private Callable scheduleDisconnectIn(final long timeout) {
        final BinaryLogClientForNewGtidSet self = this;
    ...
    private void requestBinaryLogStreamMysql(long serverId) throws IOException {
        ...
        synchronized (gtidSetAccessLock) {
            if (this.gtidEnabled) {
                dumpBinaryLogCommand = new DumpBinaryLogGtidCommandForNewGtidSet(serverId,
    ...
    public void connect(final long timeout) throws IOException, TimeoutException {
        ...
        AbstractLifecycleListener connectListener = new AbstractLifecycleListener() {
            @Override
            public void onConnect(BinaryLogClientForNewGtidSet client) {
        ...
        synchronized (gtidSetAccessLock) {
            if ( this.isMariaDB ) {
                ...
                if ( gtidSet == null && gtidSetFallbackToPurged ) {
                    gtidSet = MySqlGtidSet.fromString(fetchGtidPurged());
                } else if ( gtidSet == null ){
                    gtidSet = new MySqlGtidSet();
                }
            }
        }
    ...
    /**
     * {@link BinaryLogClientForNewGtidSet}'s event listener.
     */
    ...
    /**
     * {@link BinaryLogClientForNewGtidSet}'s lifecycle listener.
     */
    public interface LifecycleListener {
         ...
         */
        void onConnect(BinaryLogClientForNewGtidSet client);

        /**
         * It's guarantied to be called before {@link #onDisconnect(BinaryLogClientForNewGtidSet)}) in case of
         ...
         */
        void onCommunicationFailure(BinaryLogClientForNewGtidSet client, Exception ex);
         ...
         */
        void onEventDeserializationFailure(BinaryLogClientForNewGtidSet client, Exception ex);

        /**
         * Called upon disconnect (regardless of the reason).
		 * @param client the client that disconnected
         */
        void onDisconnect(BinaryLogClientForNewGtidSet client);
    }
    ...
    public static abstract class AbstractLifecycleListener implements LifecycleListener {
        ...
        public void onCommunicationFailure(BinaryLogClientForNewGtidSet client, Exception ex) { }

        public void onEventDeserializationFailure(BinaryLogClientForNewGtidSet client, Exception ex) { }

        public void onDisconnect(BinaryLogClientForNewGtidSet client) { }
