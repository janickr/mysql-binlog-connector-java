 ...
 */
package com.github.shyiko.mysql.binlog.gtidprofilingpoc.originalwithoutstring;
...
import com.github.shyiko.mysql.binlog.gtidprofilingpoc.newgtid.MySqlGtidEventData;
 ...
 */
public class BinaryLogClientForOriginalGtidSetButWithoutString implements BinaryLogClientMXBean {
    ...
    protected OriginalGtidSetButWithoutString gtidSet;
     ...
     * @see BinaryLogClientForOriginalGtidSetButWithoutString#BinaryLogClient(String, int, String, String, String)
	 * @param username login name
	 * @param password password
     */
    public BinaryLogClientForOriginalGtidSetButWithoutString(String username, String password) {
	 ...
	 * @param password password
     */
    public BinaryLogClientForOriginalGtidSetButWithoutString(String schema, String username, String password) {
	 ...
	 * @param password password
     */
    public BinaryLogClientForOriginalGtidSetButWithoutString(String hostname, int port, String username, String password) {
     ...
     * @param password password
     */
    public BinaryLogClientForOriginalGtidSetButWithoutString(String hostname, int port, String schema, String username, String password) {
        ...
        synchronized (gtidSetAccessLock) {
            if ( !gtidStr.equals("") ) {
                if ( MariadbGtidSet.isMariaGtidSet(gtidStr) ) {
                    throw new RuntimeException("MariaDB not supported in this POC");
                } else {
                    this.gtidSet = new OriginalGtidSetButWithoutString(gtidStr);
                }
            }
        }
    }
    ...
    *
    ...
    private Callable scheduleDisconnectIn(final long timeout) {
        final BinaryLogClientForOriginalGtidSetButWithoutString self = this;
    ...
    private void requestBinaryLogStreamMysql(long serverId) throws IOException {
        ...
        synchronized (gtidSetAccessLock) {
            if (this.gtidEnabled) {
                dumpBinaryLogCommand = new DumpBinaryLogGtidCommandForOriginalGtidSetButWithoutString(serverId,
    ...
    protected void ensureGtidEventDataDeserializer() {
        ensureEventDataDeserializer(EventType.GTID, MySqlGtidEventDataDeserializer.class);
    ...
    public void connect(final long timeout) throws IOException, TimeoutException {
        ...
        AbstractLifecycleListener connectListener = new AbstractLifecycleListener() {
            @Override
            public void onConnect(BinaryLogClientForOriginalGtidSetButWithoutString client) {
        ...
        synchronized (gtidSetAccessLock) {
            if ( this.isMariaDB ) {
                ...
                if ( gtidSet == null && gtidSetFallbackToPurged ) {
                    gtidSet = new OriginalGtidSetButWithoutString(fetchGtidPurged());
                } else if ( gtidSet == null ){
                    gtidSet = new OriginalGtidSetButWithoutString("");
                }
            }
        }
    ...
    protected void updateGtidSet(Event event) {
        ...
        switch(eventHeader.getEventType()) {
            case GTID:
                MySqlGtidEventData gtidEventData = (MySqlGtidEventData) EventDataWrapper.internal(event.getData());
    ...
    /**
     * {@link BinaryLogClientForOriginalGtidSetButWithoutString}'s event listener.
     */
    ...
    /**
     * {@link BinaryLogClientForOriginalGtidSetButWithoutString}'s lifecycle listener.
     */
    public interface LifecycleListener {
         ...
         */
        void onConnect(BinaryLogClientForOriginalGtidSetButWithoutString client);

        /**
         * It's guarantied to be called before {@link #onDisconnect(BinaryLogClientForOriginalGtidSetButWithoutString)}) in case of
         ...
         */
        void onCommunicationFailure(BinaryLogClientForOriginalGtidSetButWithoutString client, Exception ex);
         ...
         */
        void onEventDeserializationFailure(BinaryLogClientForOriginalGtidSetButWithoutString client, Exception ex);

        /**
         * Called upon disconnect (regardless of the reason).
		 * @param client the client that disconnected
         */
        void onDisconnect(BinaryLogClientForOriginalGtidSetButWithoutString client);
    }
    ...
    public static abstract class AbstractLifecycleListener implements LifecycleListener {
        ...
        public void onCommunicationFailure(BinaryLogClientForOriginalGtidSetButWithoutString client, Exception ex) { }

        public void onEventDeserializationFailure(BinaryLogClientForOriginalGtidSetButWithoutString client, Exception ex) { }

        public void onDisconnect(BinaryLogClientForOriginalGtidSetButWithoutString client) { }
